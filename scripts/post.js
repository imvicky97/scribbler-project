...
function addComment() {
    document.getElementById("txtCommentCommentPost").addEventListener("onchange", function () {
        document.getElementById("txtCommentCommentPost").innerHTML;
    });

    var commentValue = document.getElementById("txtCommentCommentPost").value;

    var pElement = '<p class="comment">' + commentValue + '</p>';
